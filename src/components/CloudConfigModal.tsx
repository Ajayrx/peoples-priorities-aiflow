          ...
          <div className="space-y-3 bg-slate-50 p-4 rounded-2xl border border-slate-200">
            <div className="flex items-center justify-between">
              <label className="text-xs font-extrabold text-slate-900 flex items-center gap-2">
                ...
                <span>Firebase Cloud Firestore (for Global Real-Time Map Sync)</span>
              </label>
              <span className={`px-2 py-0.5 rounded text-[10px] font-mono font-bold flex items-center gap-1 ${
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setConfig({
                    ...config,
                    firebaseConfig: { ...config.firebaseConfig, projectId: e.target.value }
                  })}
                  className="w-full px-3 py-2 rounded-xl bg-white border border-slate-300 focus:border-teal-500 font-mono text-xs text-slate-800 outline-none"
                />
              </div>
            ...
            <p className="text-[11px] text-slate-500 font-medium">
              Without Firebase keys entered, real-time sync automatically uses our multi-tab `BroadcastChannel` bus so that when you take a photo on your device, it instantly appears across all open maps and MP dashboards!
            </p>
          </div>
