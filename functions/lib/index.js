...
exports.analyzeReportImage = functions.https.onCall({
    ...
    try {
        ...
        const sizeBytes = parseInt(((_a = metadata.size) === null || _a === void 0 ? void 0 : _a.toString()) || '0', 10);
      ...
      DO NOT hallucinate facts not visible in the image.`;
        ...
        const responseText = (_b = response.response.candidates) === null || _b === void 0 ? void 0 : _b[0].content.parts[0].text;
        if (!responseText) {
